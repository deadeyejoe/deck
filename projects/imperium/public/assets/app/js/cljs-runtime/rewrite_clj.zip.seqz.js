...
var G__48255 = (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(n0) : f.call(null,n0));
var G__48255__$1 = (((G__48255 == null))?null:cljs.core.iterate((function (loc){
...
var G__48255__$2 = (((G__48255__$1 == null))?null:cljs.core.take_while.cljs$core$IFn$_invoke$arity$2(cljs.core.identity,G__48255__$1));
var G__48255__$3 = (((G__48255__$2 == null))?null:cljs.core.last(G__48255__$2));
if((G__48255__$3 == null)){
return null;
} else {
return rewrite_clj.zip.move.up(G__48255__$3);
}
} else {
return zloc;
}
...
var G__48402 = rewrite_clj.zip.move.right(v);
var G__48403 = rewrite_clj.zip.move.up(v);
loc = G__48402;
parent = G__48403;
continue;
} else {
var G__48404 = rewrite_clj.zip.move.right(v0);
var G__48405 = parent;
loc = G__48404;
parent = G__48405;
continue;
...
var G__48406 = rewrite_clj.zip.move.right(rewrite_clj.zip.move.right(v));
var G__48407 = rewrite_clj.zip.move.up(v);
loc = G__48406;
parent = G__48407;
continue;
} else {
var G__48408 = rewrite_clj.zip.move.right(rewrite_clj.zip.move.right(loc));
var G__48409 = parent;
loc = G__48408;
parent = G__48409;
continue;
...
if(rewrite_clj.zip.seqz.map_QMARK_(zloc)){
var G__48262 = zloc;
var G__48262__$1 = (((G__48262 == null))?null:rewrite_clj.zip.move.down(G__48262));
var G__48262__$2 = (((G__48262__$1 == null))?null:rewrite_clj.zip.findz.find_value.cljs$core$IFn$_invoke$arity$2(G__48262__$1,k));
if((G__48262__$2 == null)){
return null;
} else {
return rewrite_clj.zip.move.right(G__48262__$2);
}
} else {
return cljs.core.nth.cljs$core$IFn$_invoke$arity$2((function (){var G__48266 = rewrite_clj.zip.move.down(zloc);
var G__48266__$1 = (((G__48266 == null))?null:cljs.core.iterate(rewrite_clj.zip.move.right,G__48266));
if((G__48266__$1 == null)){
return null;
} else {
return cljs.core.take_while.cljs$core$IFn$_invoke$arity$2(cljs.core.identity,G__48266__$1);
}
})(),k);
}
});
