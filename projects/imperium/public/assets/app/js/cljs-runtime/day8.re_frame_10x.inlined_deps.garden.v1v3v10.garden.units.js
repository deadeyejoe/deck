 ...
 */
day8.re_frame_10x.inlined_deps.garden.v1v3v10.garden.units.convert = (function day8$re_frame_10x$inlined_deps$garden$v1v3v10$garden$units$convert(p__46440,right){
...
var m = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46441__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
var left = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46441__$1,new cljs.core.Keyword(null,"unit","unit",375175175));
...
var vec__46443 = temp__5735__auto__;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46443,(0),null);
var magnitude = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46443,(1),null);
var unit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46443,(2),null);
...
var m1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46446__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
var map__46447 = u(y);
...
var m2 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46447__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
return u((m1 + m2));
});
var day8$re_frame_10x$inlined_deps$garden$v1v3v10$garden$units$make_unit_adder_$_u_PLUS___3 = (function() { 
var G__46510__delegate = function (x,y,more){
...
var G__46510 = function (x,y,var_args){
var more = null;
if (arguments.length > 2) {
var G__46511__i = 0, G__46511__a = new Array(arguments.length -  2);
while (G__46511__i < G__46511__a.length) {G__46511__a[G__46511__i] = arguments[G__46511__i + 2]; ++G__46511__i;}
  more = new cljs.core.IndexedSeq(G__46511__a,0,null);
} 
return G__46510__delegate.call(this,x,y,more);};
G__46510.cljs$lang$maxFixedArity = 2;
G__46510.cljs$lang$applyTo = (function (arglist__46512){
var x = cljs.core.first(arglist__46512);
arglist__46512 = cljs.core.next(arglist__46512);
var y = cljs.core.first(arglist__46512);
var more = cljs.core.rest(arglist__46512);
return G__46510__delegate(x,y,more);
});
...
var G__46513 = null;
if (arguments.length > 2) {
var G__46515__i = 0, G__46515__a = new Array(arguments.length -  2);
while (G__46515__i < G__46515__a.length) {G__46515__a[G__46515__i] = arguments[G__46515__i + 2]; ++G__46515__i;}
G__46513 = new cljs.core.IndexedSeq(G__46515__a,0,null);
}
return day8$re_frame_10x$inlined_deps$garden$v1v3v10$garden$units$make_unit_adder_$_u_PLUS___3.cljs$core$IFn$_invoke$arity$variadic(x,y, G__46513);
}
...
var m1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46450__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
var map__46451 = u(y);
var map__46451__$1 = (((((!((map__46451 == null))))?(((((map__46451.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__46451.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__46451):map__46451);
var m2 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46451__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
return u((m1 - m2));
});
var day8$re_frame_10x$inlined_deps$garden$v1v3v10$garden$units$make_unit_subtractor_$_u___3 = (function() { 
var G__46523__delegate = function (x,y,more){
...
var G__46523 = function (x,y,var_args){
var more = null;
if (arguments.length > 2) {
var G__46527__i = 0, G__46527__a = new Array(arguments.length -  2);
while (G__46527__i < G__46527__a.length) {G__46527__a[G__46527__i] = arguments[G__46527__i + 2]; ++G__46527__i;}
  more = new cljs.core.IndexedSeq(G__46527__a,0,null);
} 
return G__46523__delegate.call(this,x,y,more);};
G__46523.cljs$lang$maxFixedArity = 2;
G__46523.cljs$lang$applyTo = (function (arglist__46528){
var x = cljs.core.first(arglist__46528);
arglist__46528 = cljs.core.next(arglist__46528);
var y = cljs.core.first(arglist__46528);
var more = cljs.core.rest(arglist__46528);
return G__46523__delegate(x,y,more);
});
...
var G__46529 = null;
if (arguments.length > 2) {
var G__46530__i = 0, G__46530__a = new Array(arguments.length -  2);
while (G__46530__i < G__46530__a.length) {G__46530__a[G__46530__i] = arguments[G__46530__i + 2]; ++G__46530__i;}
G__46529 = new cljs.core.IndexedSeq(G__46530__a,0,null);
}
return day8$re_frame_10x$inlined_deps$garden$v1v3v10$garden$units$make_unit_subtractor_$_u___3.cljs$core$IFn$_invoke$arity$variadic(x,y, G__46529);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
...
var m1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46454__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
var map__46455 = u(y);
...
var m2 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46455__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
...
var G__46540__delegate = function (x,y,more){
...
var G__46540 = function (x,y,var_args){
var more = null;
if (arguments.length > 2) {
var G__46542__i = 0, G__46542__a = new Array(arguments.length -  2);
while (G__46542__i < G__46542__a.length) {G__46542__a[G__46542__i] = arguments[G__46542__i + 2]; ++G__46542__i;}
  more = new cljs.core.IndexedSeq(G__46542__a,0,null);
} 
return G__46540__delegate.call(this,x,y,more);};
G__46540.cljs$lang$maxFixedArity = 2;
G__46540.cljs$lang$applyTo = (function (arglist__46545){
var x = cljs.core.first(arglist__46545);
arglist__46545 = cljs.core.next(arglist__46545);
var y = cljs.core.first(arglist__46545);
var more = cljs.core.rest(arglist__46545);
return G__46540__delegate(x,y,more);
});
...
var G__46548 = null;
if (arguments.length > 2) {
var G__46549__i = 0, G__46549__a = new Array(arguments.length -  2);
while (G__46549__i < G__46549__a.length) {G__46549__a[G__46549__i] = arguments[G__46549__i + 2]; ++G__46549__i;}
G__46548 = new cljs.core.IndexedSeq(G__46549__a,0,null);
}
return day8$re_frame_10x$inlined_deps$garden$v1v3v10$garden$units$make_unit_multiplier_$_u_STAR___3.cljs$core$IFn$_invoke$arity$variadic(x,y, G__46548);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
...
var G__46553__delegate = function (x,y,more){
...
var G__46553 = function (x,y,var_args){
var more = null;
if (arguments.length > 2) {
var G__46559__i = 0, G__46559__a = new Array(arguments.length -  2);
while (G__46559__i < G__46559__a.length) {G__46559__a[G__46559__i] = arguments[G__46559__i + 2]; ++G__46559__i;}
  more = new cljs.core.IndexedSeq(G__46559__a,0,null);
} 
return G__46553__delegate.call(this,x,y,more);};
G__46553.cljs$lang$maxFixedArity = 2;
G__46553.cljs$lang$applyTo = (function (arglist__46560){
var x = cljs.core.first(arglist__46560);
arglist__46560 = cljs.core.next(arglist__46560);
var y = cljs.core.first(arglist__46560);
var more = cljs.core.rest(arglist__46560);
return G__46553__delegate(x,y,more);
});
...
var G__46562 = null;
if (arguments.length > 2) {
var G__46563__i = 0, G__46563__a = new Array(arguments.length -  2);
while (G__46563__i < G__46563__a.length) {G__46563__a[G__46563__i] = arguments[G__46563__i + 2]; ++G__46563__i;}
G__46562 = new cljs.core.IndexedSeq(G__46563__a,0,null);
}
return day8$re_frame_10x$inlined_deps$garden$v1v3v10$garden$units$make_unit_divider_$_ud__3.cljs$core$IFn$_invoke$arity$variadic(x,y, G__46562);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
