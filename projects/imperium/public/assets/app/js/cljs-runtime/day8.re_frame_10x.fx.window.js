...
return clojure.string.join.cljs$core$IFn$_invoke$arity$2(",",cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret,p__45465){
var vec__45467 = p__45465;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45467,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45467,(1),null);
 ...
 */
day8.re_frame_10x.fx.window.open_debugger_window = (function day8$re_frame_10x$fx$window$open_debugger_window(p__45494){
var map__45498 = p__45494;
var map__45498__$1 = (((((!((map__45498 == null))))?(((((map__45498.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__45498.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__45498):map__45498);
var width = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45498__$1,new cljs.core.Keyword(null,"width","width",-384071477));
var height = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45498__$1,new cljs.core.Keyword(null,"height","height",1025178622));
var top = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45498__$1,new cljs.core.Keyword(null,"top","top",-1856271961));
var left = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45498__$1,new cljs.core.Keyword(null,"left","left",-399115937));
var on_load = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45498__$1,new cljs.core.Keyword(null,"on-load","on-load",1415151594));
var on_success = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45498__$1,new cljs.core.Keyword(null,"on-success","on-success",1786904109));
var on_failure = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45498__$1,new cljs.core.Keyword(null,"on-failure","on-failure",842888245));
