...
return [(function (){var pred__42284 = cljs.core.instance_QMARK_;
var expr__42285 = reactive_val;
if(cljs.core.truth_((pred__42284.cljs$core$IFn$_invoke$arity$2 ? pred__42284.cljs$core$IFn$_invoke$arity$2(day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.ratom.RAtom,expr__42285) : pred__42284.call(null,day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.ratom.RAtom,expr__42285)))){
return "ra";
} else {
if(cljs.core.truth_((pred__42284.cljs$core$IFn$_invoke$arity$2 ? pred__42284.cljs$core$IFn$_invoke$arity$2(day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.ratom.RCursor,expr__42285) : pred__42284.call(null,day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.ratom.RCursor,expr__42285)))){
return "rc";
} else {
if(cljs.core.truth_((pred__42284.cljs$core$IFn$_invoke$arity$2 ? pred__42284.cljs$core$IFn$_invoke$arity$2(day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.ratom.Reaction,expr__42285) : pred__42284.call(null,day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.ratom.Reaction,expr__42285)))){
return "rx";
} else {
if(cljs.core.truth_((pred__42284.cljs$core$IFn$_invoke$arity$2 ? pred__42284.cljs$core$IFn$_invoke$arity$2(day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.ratom.Track,expr__42285) : pred__42284.call(null,day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.ratom.Track,expr__42285)))){
return "tr";
} else {
return "other";
}
