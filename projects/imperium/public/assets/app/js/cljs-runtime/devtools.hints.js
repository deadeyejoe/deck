...
var map__41079 = top_item;
var map__41079__$1 = (((((!((map__41079 == null))))?(((((map__41079.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__41079.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__41079):map__41079);
var file = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41079__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41079__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41079__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error(error.message,file,line,column);
}catch (e41078){var _e = e41078;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5733__auto___41106 = devtools.hints.get_processed_errors_BANG_();
if(cljs.core.truth_(temp__5733__auto___41106)){
var seen_errors_41107 = temp__5733__auto___41106;
if(cljs.core.truth_(seen_errors_41107.has(self))){
} else {
seen_errors_41107.add(self);

var temp__5735__auto___41108 = devtools.hints.error_object_sense(self);
if(cljs.core.truth_(temp__5735__auto___41108)){
var sense_41109 = temp__5735__auto___41108;
(self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_41109)].join(''));
} else {
}
}
} else {
