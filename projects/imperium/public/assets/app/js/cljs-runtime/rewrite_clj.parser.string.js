...
if((c === "\n")){
var G__48000 = escape_QMARK_;
var G__48001 = rewrite_clj.parser.string.flush_into(lines,buf);
escape_QMARK_ = G__48000;
lines = G__48001;
continue;
} else {
buf.append(c);

var G__48002 = ((cljs.core.not(escape_QMARK_)) && ((c === "\\")));
var G__48003 = lines;
escape_QMARK_ = G__48002;
lines = G__48003;
continue;
...
var G__47990 = rewrite_clj.parser.string.read_string_data(reader);
return (rewrite_clj.node.string_node.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.node.string_node.cljs$core$IFn$_invoke$arity$1(G__47990) : rewrite_clj.node.string_node.call(null,G__47990));
});
...
var G__47992 = cljs.core.re_pattern(regex);
var G__47993 = ["#\"",regex,"\""].join('');
return (rewrite_clj.node.token_node.cljs$core$IFn$_invoke$arity$2 ? rewrite_clj.node.token_node.cljs$core$IFn$_invoke$arity$2(G__47992,G__47993) : rewrite_clj.node.token_node.call(null,G__47992,G__47993));
});
