...
(rewrite_clj.node.keyword.KeywordNode.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4382__auto__,k46909,else__4383__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k46909,else__4383__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__4402__auto__,p__46946){
var vec__46947 = p__46946;
var k__4403__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46947,(0),null);
var v__4404__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46947,(1),null);
...
(rewrite_clj.node.keyword.KeywordNode.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__46908){
var self__ = this;
var G__46908__$1 = this;
return (new cljs.core.RecordIter((0),G__46908__$1,2,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"k","k",-2146297393),new cljs.core.Keyword(null,"namespaced?","namespaced?",-877312877)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(rewrite_clj.node.keyword.KeywordNode.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this46910,other46911){
var self__ = this;
var this46910__$1 = this;
return (((!((other46911 == null)))) && ((this46910__$1.constructor === other46911.constructor)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this46910__$1.k,other46911.k)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this46910__$1.namespaced_QMARK_,other46911.namespaced_QMARK_)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this46910__$1.__extmap,other46911.__extmap)));
}));
...
(rewrite_clj.node.keyword.KeywordNode.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4387__auto__,k__4388__auto__,G__46908){
var self__ = this;
var this__4387__auto____$1 = this;
var pred__46979 = cljs.core.keyword_identical_QMARK_;
var expr__46980 = k__4388__auto__;
if(cljs.core.truth_((pred__46979.cljs$core$IFn$_invoke$arity$2 ? pred__46979.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"k","k",-2146297393),expr__46980) : pred__46979.call(null,new cljs.core.Keyword(null,"k","k",-2146297393),expr__46980)))){
return (new rewrite_clj.node.keyword.KeywordNode(G__46908,self__.namespaced_QMARK_,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__46979.cljs$core$IFn$_invoke$arity$2 ? pred__46979.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"namespaced?","namespaced?",-877312877),expr__46980) : pred__46979.call(null,new cljs.core.Keyword(null,"namespaced?","namespaced?",-877312877),expr__46980)))){
return (new rewrite_clj.node.keyword.KeywordNode(self__.k,G__46908,self__.__meta,self__.__extmap,null));
} else {
return (new rewrite_clj.node.keyword.KeywordNode(self__.k,self__.namespaced_QMARK_,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4388__auto__,G__46908),null));
}
}
}));
...
(rewrite_clj.node.keyword.KeywordNode.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4379__auto__,G__46908){
var self__ = this;
var this__4379__auto____$1 = this;
return (new rewrite_clj.node.keyword.KeywordNode(self__.k,self__.namespaced_QMARK_,G__46908,self__.__extmap,self__.__hash));
}));
 ...
 */
rewrite_clj.node.keyword.map__GT_KeywordNode = (function rewrite_clj$node$keyword$map__GT_KeywordNode(G__46912){
var extmap__4419__auto__ = (function (){var G__46991 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__46912,new cljs.core.Keyword(null,"k","k",-2146297393),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"namespaced?","namespaced?",-877312877)], 0));
if(cljs.core.record_QMARK_(G__46912)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__46991);
} else {
return G__46991;
}
})();
return (new rewrite_clj.node.keyword.KeywordNode(new cljs.core.Keyword(null,"k","k",-2146297393).cljs$core$IFn$_invoke$arity$1(G__46912),new cljs.core.Keyword(null,"namespaced?","namespaced?",-877312877).cljs$core$IFn$_invoke$arity$1(G__46912),null,cljs.core.not_empty(extmap__4419__auto__),null));
});
...
var len__4736__auto___47018 = arguments.length;
var i__4737__auto___47019 = (0);
while(true){
if((i__4737__auto___47019 < len__4736__auto___47018)){
args__4742__auto__.push((arguments[i__4737__auto___47019]));

var G__47022 = (i__4737__auto___47019 + (1));
i__4737__auto___47019 = G__47022;
continue;
} else {
}
break;
...
(rewrite_clj.node.keyword.keyword_node.cljs$core$IFn$_invoke$arity$variadic = (function (k,p__47000){
var vec__47001 = p__47000;
var namespaced_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47001,(0),null);
...
/** @this {Function} */
(rewrite_clj.node.keyword.keyword_node.cljs$lang$applyTo = (function (seq46992){
var G__46993 = cljs.core.first(seq46992);
var seq46992__$1 = cljs.core.next(seq46992);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__46993,seq46992__$1);
}));
