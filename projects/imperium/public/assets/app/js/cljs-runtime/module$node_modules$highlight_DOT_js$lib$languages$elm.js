...
keywords:"port",contains:[COMMENT]},{className:"string",begin:"'\\\\?.",end:"'",illegal:"."},hljs.QUOTE_STRING_MODE,hljs.C_NUMBER_MODE,CONSTRUCTOR,hljs.inherit(hljs.TITLE_MODE,{begin:"^[_a-z][\\w']*"}),COMMENT,{begin:"-\x3e|\x3c-"}],illegal:/;/}}}
