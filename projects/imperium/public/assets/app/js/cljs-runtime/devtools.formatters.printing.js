...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq41239){
var G__41240 = cljs.core.first(seq41239);
var seq41239__$1 = cljs.core.next(seq41239);
var G__41241 = cljs.core.first(seq41239__$1);
var seq41239__$2 = cljs.core.next(seq41239__$1);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__41240,G__41241,seq41239__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__41261_SHARP_){
return (!((cljs.core.meta(p1__41261_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41274__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e41278){var _e__40571__auto__ = e41278;
return false;
}})();
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
...
}catch (e41282){var _e__40571__auto__ = e41282;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__41289 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__41290 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__41290);

try{var map__41291 = opts;
var map__41291__$1 = (((((!((map__41291 == null))))?(((((map__41291.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__41291.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__41291):map__41291);
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41291__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__41289);
}});
...
var temp__5733__auto___41311 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5733__auto___41311)){
var managed_print_level_41312 = temp__5733__auto___41311;
var _STAR_print_level_STAR__orig_val__41296_41313 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__41297_41314 = managed_print_level_41312;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__41297_41314);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__41293_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__41293_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__41296_41313);
}} else {
job_fn();
}
