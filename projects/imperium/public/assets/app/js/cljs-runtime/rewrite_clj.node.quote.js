...
(rewrite_clj.node.quote.QuoteNode.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4382__auto__,k46915,else__4383__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k46915,else__4383__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__4402__auto__,p__46941){
var vec__46942 = p__46941;
var k__4403__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46942,(0),null);
var v__4404__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46942,(1),null);
...
(rewrite_clj.node.quote.QuoteNode.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__46914){
var self__ = this;
var G__46914__$1 = this;
return (new cljs.core.RecordIter((0),G__46914__$1,4,new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"tag","tag",-1290361223),new cljs.core.Keyword(null,"prefix","prefix",-265908465),new cljs.core.Keyword(null,"sym","sym",-1444860305),new cljs.core.Keyword(null,"children","children",-940561982)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(rewrite_clj.node.quote.QuoteNode.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this46920,other46921){
var self__ = this;
var this46920__$1 = this;
return (((!((other46921 == null)))) && ((this46920__$1.constructor === other46921.constructor)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this46920__$1.tag,other46921.tag)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this46920__$1.prefix,other46921.prefix)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this46920__$1.sym,other46921.sym)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this46920__$1.children,other46921.children)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this46920__$1.__extmap,other46921.__extmap)));
}));
...
(rewrite_clj.node.quote.QuoteNode.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4387__auto__,k__4388__auto__,G__46914){
var self__ = this;
var this__4387__auto____$1 = this;
var pred__46966 = cljs.core.keyword_identical_QMARK_;
var expr__46967 = k__4388__auto__;
if(cljs.core.truth_((pred__46966.cljs$core$IFn$_invoke$arity$2 ? pred__46966.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"tag","tag",-1290361223),expr__46967) : pred__46966.call(null,new cljs.core.Keyword(null,"tag","tag",-1290361223),expr__46967)))){
return (new rewrite_clj.node.quote.QuoteNode(G__46914,self__.prefix,self__.sym,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__46966.cljs$core$IFn$_invoke$arity$2 ? pred__46966.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"prefix","prefix",-265908465),expr__46967) : pred__46966.call(null,new cljs.core.Keyword(null,"prefix","prefix",-265908465),expr__46967)))){
return (new rewrite_clj.node.quote.QuoteNode(self__.tag,G__46914,self__.sym,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__46966.cljs$core$IFn$_invoke$arity$2 ? pred__46966.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"sym","sym",-1444860305),expr__46967) : pred__46966.call(null,new cljs.core.Keyword(null,"sym","sym",-1444860305),expr__46967)))){
return (new rewrite_clj.node.quote.QuoteNode(self__.tag,self__.prefix,G__46914,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__46966.cljs$core$IFn$_invoke$arity$2 ? pred__46966.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"children","children",-940561982),expr__46967) : pred__46966.call(null,new cljs.core.Keyword(null,"children","children",-940561982),expr__46967)))){
return (new rewrite_clj.node.quote.QuoteNode(self__.tag,self__.prefix,self__.sym,G__46914,self__.__meta,self__.__extmap,null));
} else {
return (new rewrite_clj.node.quote.QuoteNode(self__.tag,self__.prefix,self__.sym,self__.children,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4388__auto__,G__46914),null));
}
}
}
}
...
(rewrite_clj.node.quote.QuoteNode.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4379__auto__,G__46914){
var self__ = this;
var this__4379__auto____$1 = this;
return (new rewrite_clj.node.quote.QuoteNode(self__.tag,self__.prefix,self__.sym,self__.children,G__46914,self__.__extmap,self__.__hash));
}));
 ...
 */
rewrite_clj.node.quote.map__GT_QuoteNode = (function rewrite_clj$node$quote$map__GT_QuoteNode(G__46926){
var extmap__4419__auto__ = (function (){var G__46974 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__46926,new cljs.core.Keyword(null,"tag","tag",-1290361223),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"prefix","prefix",-265908465),new cljs.core.Keyword(null,"sym","sym",-1444860305),new cljs.core.Keyword(null,"children","children",-940561982)], 0));
if(cljs.core.record_QMARK_(G__46926)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__46974);
} else {
return G__46974;
}
})();
return (new rewrite_clj.node.quote.QuoteNode(new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(G__46926),new cljs.core.Keyword(null,"prefix","prefix",-265908465).cljs$core$IFn$_invoke$arity$1(G__46926),new cljs.core.Keyword(null,"sym","sym",-1444860305).cljs$core$IFn$_invoke$arity$1(G__46926),new cljs.core.Keyword(null,"children","children",-940561982).cljs$core$IFn$_invoke$arity$1(G__46926),null,cljs.core.not_empty(extmap__4419__auto__),null));
});
...
var G__47004 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [children], null);
children = G__47004;
continue;
}
break;
...
var G__47005 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [children], null);
children = G__47005;
continue;
}
break;
...
var G__47006 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [children], null);
children = G__47006;
continue;
}
break;
...
var G__47007 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [children], null);
children = G__47007;
continue;
}
break;
