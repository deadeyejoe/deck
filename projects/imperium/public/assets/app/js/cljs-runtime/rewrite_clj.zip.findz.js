...
var len__4736__auto___48241 = arguments.length;
var i__4737__auto___48242 = (0);
while(true){
if((i__4737__auto___48242 < len__4736__auto___48241)){
args__4742__auto__.push((arguments[i__4737__auto___48242]));

var G__48243 = (i__4737__auto___48242 + (1));
i__4737__auto___48242 = G__48243;
continue;
} else {
}
break;
...
(rewrite_clj.zip.findz.tag_predicate.cljs$core$IFn$_invoke$arity$variadic = (function (t,p__48188){
var vec__48189 = p__48188;
var additional = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48189,(0),null);
...
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(rewrite_clj.zip.base.tag(p1__48185_SHARP_),t);
});
}
}));
...
/** @this {Function} */
(rewrite_clj.zip.findz.tag_predicate.cljs$lang$applyTo = (function (seq48186){
var G__48187 = cljs.core.first(seq48186);
var seq48186__$1 = cljs.core.next(seq48186);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__48187,seq48186__$1);
}));

rewrite_clj.zip.findz.in_range_QMARK_ = (function rewrite_clj$zip$findz$in_range_QMARK_(p__48192,p__48193){
var map__48196 = p__48192;
...
var row = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48196__$1,new cljs.core.Keyword(null,"row","row",-570139521));
var col = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48196__$1,new cljs.core.Keyword(null,"col","col",-1959363084));
var end_row = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48196__$1,new cljs.core.Keyword(null,"end-row","end-row",-545103581));
var end_col = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48196__$1,new cljs.core.Keyword(null,"end-col","end-col",-724155879));
var map__48197 = p__48193;
...
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48197__$1,new cljs.core.Keyword(null,"row","row",-570139521));
var c = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48197__$1,new cljs.core.Keyword(null,"col","col",-1959363084));
if((r >= row)){
if((r <= end_row)){
...
return cljs.core.last(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__48208_SHARP_){
var and__4115__auto__ = (p_QMARK_.cljs$core$IFn$_invoke$arity$1 ? p_QMARK_.cljs$core$IFn$_invoke$arity$1(p1__48208_SHARP_) : p_QMARK_.call(null,p1__48208_SHARP_));
if(cljs.core.truth_(and__4115__auto__)){
return rewrite_clj.zip.findz.in_range_QMARK_(cljs.core.meta(clojure.zip.node(p1__48208_SHARP_)),pos);
} else {
...
var G__48218 = zloc;
var G__48218__$1 = (((G__48218 == null))?null:(f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(G__48218) : f.call(null,G__48218)));
if((G__48218__$1 == null)){
return null;
} else {
return rewrite_clj.zip.findz.find.cljs$core$IFn$_invoke$arity$3(G__48218__$1,f,p_QMARK_);
}
}));
...
return rewrite_clj.zip.findz.find.cljs$core$IFn$_invoke$arity$3(zloc,f,(function (p1__48220_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(rewrite_clj.zip.base.tag(p1__48220_SHARP_),t);
}));
}));
...
return rewrite_clj.zip.findz.find_last_by_pos.cljs$core$IFn$_invoke$arity$3(zloc,pos,(function (p1__48231_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(rewrite_clj.zip.base.tag(p1__48231_SHARP_),t);
}));
});
/**
...
var p_QMARK_ = ((cljs.core.set_QMARK_(v))?cljs.core.comp.cljs$core$IFn$_invoke$arity$2(v,rewrite_clj.zip.base.sexpr):(function (p1__48236_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(rewrite_clj.zip.base.sexpr(p1__48236_SHARP_),v);
}));
