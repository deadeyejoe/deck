...
var G__41237 = devtools.prefs.pref(v);
v = G__41237;
continue;
} else {
return v;
...
}catch (e41207){var _e__40571__auto__ = e41207;
return false;
}})();
...
}catch (e41212){var _e__40571__auto__ = e41212;
return false;
}})();
...
}catch (e41214){var _e__40571__auto__ = e41214;
return false;
}}
}
});
...
var vec__41226 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41226,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41226,(1),null);
...
return cljs.core.some((function (p1__41229_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__41229_SHARP_);
}),template);
});
