...
zprint.finish.no_style_map = new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"f","f",-1597136552),(function (p1__46605_SHARP_){
if(cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__46605_SHARP_,new cljs.core.Keyword(null,"none","none",1333468478))){
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"reverse","reverse",-888455266)], null),p1__46605_SHARP_);
} else {
 ...
 */
zprint.finish.within_QMARK_ = (function zprint$finish$within_QMARK_(n,p__46611){
var vec__46612 = p__46611;
var low = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46612,(0),null);
var high = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46612,(1),null);
return (((n >= low)) && ((n <= high)));
});
/**
 ...
 */
zprint.finish.ground_color_to_style = (function zprint$finish$ground_color_to_style(p__46621,s,color,element,idx){
...
var style_map = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46622__$1,new cljs.core.Keyword(null,"style-map","style-map",1488693527));
var focus = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46622__$1,new cljs.core.Keyword(null,"focus","focus",234677911));
var select = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46622__$1,new cljs.core.Keyword(null,"select","select",1147833503));
...
var G__46633 = (function (){var or__4126__auto__ = color;
...
var fexpr__46632 = (function (){var G__46634 = ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(element,new cljs.core.Keyword(null,"cursor-element","cursor-element",-616791907)))?(function (){
...
return (style_map.cljs$core$IFn$_invoke$arity$1 ? style_map.cljs$core$IFn$_invoke$arity$1(G__46634) : style_map.call(null,G__46634));
})();
return (fexpr__46632.cljs$core$IFn$_invoke$arity$1 ? fexpr__46632.cljs$core$IFn$_invoke$arity$1(G__46633) : fexpr__46632.call(null,G__46633));
} else {
return null;
}
});
 ...
 */
zprint.finish.add_length = (function zprint$finish$add_length(p__46641){
var vec__46643 = p__46641;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46643,(0),null);
var style = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46643,(1),null);
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46643,(2),null);
 ...
 *   which are in focus.
 */
zprint.finish.gc_vec_to_style_vec = (function zprint$finish$gc_vec_to_style_vec(ctx,idx,p__46646){
var vec__46656 = p__46646;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46656,(0),null);
var keyword_color = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46656,(1),null);
var element = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46656,(2),null);
...
var G__46870 = cljs.core.next(ssv);
var G__46871 = (this_ssv == null);
var G__46872 = (cljs.core.truth_(this_elide)?this_elide:last_elide);
var G__46873 = ((((doing_nil_QMARK_) && ((this_ssv == null))))?out:((((doing_nil_QMARK_) && ((!((this_ssv == null))))))?cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,zprint.finish.gc_vec_to_style_vec(ctx,(0),this_elide)),zprint.finish.gc_vec_to_style_vec(ctx,(0),elide__$1)),this_ssv):(((this_ssv == null))?out:cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,this_ssv)
)));
ssv = G__46870;
doing_nil_QMARK_ = G__46871;
last_elide = G__46872;
out = G__46873;
continue;
}
...
var vec__46681 = cljs.core.first(remaining_cvec);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46681,(0),null);
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46681,(1),null);
var element_type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46681,(2),null);
...
var G__46878 = cljs.core.next(remaining_cvec);
var G__46879 = new_idx;
var G__46880 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new_idx);
remaining_cvec = G__46878;
idx = G__46879;
out = G__46880;
continue;
}
 ...
 */
zprint.finish.replace_focus_w_cursor = (function zprint$finish$replace_focus_w_cursor(gcw_vec,p__46735,cursor_vec){
var vec__46736 = p__46735;
var focus_start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46736,(0),null);
var focus_end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46736,(1),null);
var focus_vec = vec__46736;
...
var vec__46739 = cljs.core.split_at(focus_start,gcw_vec);
var front = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46739,(0),null);
var back = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46739,(1),null);
 ...
 */
zprint.finish.color_style = (function zprint$finish$color_style(p__46743){
var vec__46744 = p__46743;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46744,(0),null);
var color = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46744,(1),null);
if((color == null)){
return s;
} else {
...
(zprint.finish.cursor_style.cljs$core$IFn$_invoke$arity$2 = (function (p__46760,existing_count){
var vec__46761 = p__46760;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46761,(0),null);
var cursor = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46761,(1),null);
...
return cljs.core.filterv((function (p1__46755_SHARP_){
return (!(cljs.core.empty_QMARK_(cljs.core.first(p1__46755_SHARP_))));
...
var vec__46797 = cljs.core.first(cvec_nl);
var n = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46797,(0),null);
var where = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46797,(1),null);
var cvec_element = vec__46797;
if((cvec_element == null)){
var G__46916 = cljs.core.next(cvec_nl);
var G__46917 = (idx + (1));
var G__46918 = start;
var G__46919 = out;
cvec_nl = G__46916;
...
var G__46922 = cljs.core.next(cvec_nl);
var G__46923 = (idx + (1));
var G__46924 = idx;
var G__46925 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,(idx - (1))], null));
cvec_nl = G__46922;
idx = G__46923;
start = G__46924;
out = G__46925;
...
var G__46927 = cljs.core.next(cvec_nl);
var G__46928 = (idx + (1));
var G__46929 = (idx + (1));
var G__46930 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,idx], null));
cvec_nl = G__46927;
idx = G__46928;
start = G__46929;
out = G__46930;
...
var G__46932 = cljs.core.next(cvec_nl);
var G__46933 = (idx + (1));
var G__46934 = idx;
var G__46935 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.conj,cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,(idx - (1))], null)),cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(n,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [idx,idx], null)));
cvec_nl = G__46932;
idx = G__46933;
start = G__46934;
out = G__46935;
...
var G__46936 = cljs.core.next(cvec_nl);
var G__46937 = (idx + (1));
var G__46938 = start;
var G__46939 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.conj,out,cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(n,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,idx], null)));
cvec_nl = G__46936;
idx = G__46937;
start = G__46938;
out = G__46939;
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__46809_SHARP_,p2__46808_SHARP_){
if(zprint.finish.within_QMARK_(idx,p2__46808_SHARP_)){
return cljs.core.reduced(p1__46809_SHARP_);
} else {
return (p1__46809_SHARP_ + (1));
}
}),(0),lines);
});
/**
 ...
 */
zprint.finish.surround_focus = (function zprint$finish$surround_focus(lines_to_cvec,p__46811,p__46812){
var vec__46813 = p__46811;
var focus_begin = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46813,(0),null);
var focus_end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46813,(1),null);
var vec__46816 = p__46812;
var before = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46816,(0),null);
var after = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46816,(1),null);
 ...
 */
zprint.finish.handle_lines = (function zprint$finish$handle_lines(p__46831,cvec,focus_vec){
...
var options = map__46832__$1;
var map__46833 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46832__$1,new cljs.core.Keyword(null,"output","output",-1105869043));
...
var focus = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46833__$1,new cljs.core.Keyword(null,"focus","focus",234677911));
var lines = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46833__$1,new cljs.core.Keyword(null,"lines","lines",-700165781));
var paths = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46833__$1,new cljs.core.Keyword(null,"paths","paths",-1807389588));
...
var path_vecs__$1 = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__46829_SHARP_){
return zprint.finish.surround_focus(lines_to_cvec,p1__46829_SHARP_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(0),(0)], null));
}),path_vecs);
