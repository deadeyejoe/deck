...
var G__46608 = new_next_nonws_QMARK_;
index = G__46606;
skip_to_right_QMARK_ = G__46607;
next_nonws_QMARK_ = G__46608;
continue;
}
}
break;
...
var G__46615 = zprint.focus.next_ssv(ssv,index);
var G__46616 = (moves - (1));
index = G__46615;
moves = G__46616;
continue;
}
...
var G__46617 = zprint.focus.right_ssv(cljs.core.first(nwp),ssv,zprint.focus.down_ssv(ssv,idx));
var G__46618 = cljs.core.next(nwp);
idx = G__46617;
nwp = G__46618;
continue;
}
