...
return [(function (){var pred__43263 = cljs.core.instance_QMARK_;
var expr__43264 = reactive_val;
if(cljs.core.truth_((pred__43263.cljs$core$IFn$_invoke$arity$2 ? pred__43263.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RAtom,expr__43264) : pred__43263.call(null,reagent.ratom.RAtom,expr__43264)))){
return "ra";
} else {
if(cljs.core.truth_((pred__43263.cljs$core$IFn$_invoke$arity$2 ? pred__43263.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RCursor,expr__43264) : pred__43263.call(null,reagent.ratom.RCursor,expr__43264)))){
return "rc";
} else {
if(cljs.core.truth_((pred__43263.cljs$core$IFn$_invoke$arity$2 ? pred__43263.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Reaction,expr__43264) : pred__43263.call(null,reagent.ratom.Reaction,expr__43264)))){
return "rx";
} else {
if(cljs.core.truth_((pred__43263.cljs$core$IFn$_invoke$arity$2 ? pred__43263.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Track,expr__43264) : pred__43263.call(null,reagent.ratom.Track,expr__43264)))){
return "tr";
} else {
return "other";
}
