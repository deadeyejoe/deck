...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__41970 = c;
var G__41970__$1 = (((G__41970 == null))?null:G__41970.prototype);
if((G__41970__$1 == null)){
return null;
} else {
return G__41970__$1.reagentRender;
}
})() == null)))));
});
...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__41975 = c;
var G__41975__$1 = (((G__41975 == null))?null:G__41975.prototype);
if((G__41975__$1 == null)){
return null;
} else {
return G__41975__$1.render;
}
})() == null)))));
});
...
var or__4126__auto__ = (function (){var G__41981 = c;
var G__41981__$1 = (((G__41981 == null))?null:G__41981.constructor);
if((G__41981__$1 == null)){
return null;
} else {
return G__41981__$1.displayName;
}
})();
...
var G__41982 = c;
var G__41982__$1 = (((G__41982 == null))?null:G__41982.constructor);
if((G__41982__$1 == null)){
return null;
} else {
return G__41982__$1.name;
}
}
});
...
var _STAR_current_component_STAR__orig_val__41983 = day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__41984 = c;
(day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__41984);
...
}finally {(day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__41983);
}});
...
var G__41991 = key;
var G__41991__$1 = (((G__41991 instanceof cljs.core.Keyword))?G__41991.fqn:null);
switch (G__41991__$1) {
...
var c = this;
var G__41994_42085 = goog.object.get(c,"cljsRatom");
if((G__41994_42085 == null)){
} else {
day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.ratom.dispose_BANG_(G__41994_42085);
}
...
var renders_42087 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383)], null));
var render_fun_42088 = cljs.core.first(cljs.core.vals(renders_42087));
...
if((cljs.core.count(renders_42087) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_42087))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_42088)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_42088], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var G__41998 = o;
goog.object.set(G__41998,cljs.core.name(k),v);
...
return (function() { 
var G__42091__delegate = function (args){
return day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.impl.protocols.as_element(compiler,cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.vector,res,args));
};
...
while (G__42092__i < G__42092__a.length) {G__42092__a[G__42092__i] = arguments[G__42092__i + 0]; ++G__42092__i;}
  args = new cljs.core.IndexedSeq(G__42092__a,0,null);
} 
return G__42091__delegate.call(this,args);};
G__42091.cljs$lang$maxFixedArity = 0;
G__42091.cljs$lang$applyTo = (function (arglist__42093){
var args = cljs.core.seq(arglist__42093);
return G__42091__delegate(args);
});
...
var _STAR_current_component_STAR__orig_val__42055 = day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__42056 = c;
(day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__42056);
...
}finally {(day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__42055);
}});
...
var vec__42061 = module$node_modules$react$index.useState((0));
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42061,(0),null);
var update_count = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42061,(1),null);
...
var G__42064 = goog.object.get(reagent_state,"cljsRatom");
if((G__42064 == null)){
return null;
} else {
return day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.ratom.dispose_BANG_(G__42064);
}
});
}),[]);
