...
var G__48793 = (rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1(n) : rewrite_clj.zip.next.call(null,n));
loc = G__48793;
continue;
} else {
var G__48794 = (rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1(loc) : rewrite_clj.zip.next.call(null,loc));
loc = G__48794;
continue;
}
} else {
var G__48795 = (rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1(loc) : rewrite_clj.zip.next.call(null,loc));
loc = G__48795;
continue;
}
}
...
var G__48761 = zloc;
var G__48762 = (function (){var G__48763 = zprint.rewrite.prewalk_subtree(p_QMARK_,f,(function (){var G__48767 = zloc;
var G__48767__$1 = (((G__48767 == null))?null:(rewrite_clj.zip.node.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.node.cljs$core$IFn$_invoke$arity$1(G__48767) : rewrite_clj.zip.node.call(null,G__48767)));
if((G__48767__$1 == null)){
return null;
} else {
return (zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1 ? zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1(G__48767__$1) : zprint.zutil.edn_STAR_.call(null,G__48767__$1));
}
})());
return (rewrite_clj.zip.root.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.root.cljs$core$IFn$_invoke$arity$1(G__48763) : rewrite_clj.zip.root.call(null,G__48763));
})();
return (rewrite_clj.zip.replace.cljs$core$IFn$_invoke$arity$2 ? rewrite_clj.zip.replace.cljs$core$IFn$_invoke$arity$2(G__48761,G__48762) : rewrite_clj.zip.replace.call(null,G__48761,G__48762));
});
/**
...
var G__48799 = (rewrite_clj.zip.down.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.down.cljs$core$IFn$_invoke$arity$1(nloc) : rewrite_clj.zip.down.call(null,nloc));
nloc = G__48799;
continue;
}
break;
...
var G__48802 = (rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1(nloc) : rewrite_clj.zip.right.call(null,nloc));
var G__48803 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,nloc);
nloc = G__48802;
out = G__48803;
continue;
} else {
...
var G__48808 = (rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1(replaced_loc) : rewrite_clj.zip.right.call(null,replaced_loc));
var G__48809 = cljs.core.next(new_loc);
var G__48810 = replaced_loc;
nloc = G__48808;
new_loc = G__48809;
last_loc = G__48810;
continue;
...
return zprint.rewrite.sort_val((function (){var G__48782 = (rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1(zloc) : rewrite_clj.zip.right.call(null,zloc));
return (rewrite_clj.zip.down.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.down.cljs$core$IFn$_invoke$arity$1(G__48782) : rewrite_clj.zip.down.call(null,G__48782));
})());
});
/**
...
var new_dep = zprint.rewrite.prewalk(zloc,(function (p1__48783_SHARP_){
return ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2((rewrite_clj.zip.tag.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.tag.cljs$core$IFn$_invoke$arity$1(p1__48783_SHARP_) : rewrite_clj.zip.tag.call(null,p1__48783_SHARP_)),new cljs.core.Keyword(null,"token","token",-1211463215))) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2((rewrite_clj.zip.sexpr.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.sexpr.cljs$core$IFn$_invoke$arity$1(p1__48783_SHARP_) : rewrite_clj.zip.sexpr.call(null,p1__48783_SHARP_)),new cljs.core.Keyword(null,"dependencies","dependencies",1108064605))));
