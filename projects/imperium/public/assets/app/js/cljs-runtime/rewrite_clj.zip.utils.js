...
rewrite_clj.zip.utils.update_in_path = (function rewrite_clj$zip$utils$update_in_path(p__47394,k,f){
var vec__47395 = p__47394;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47395,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47395,(1),null);
var loc = vec__47395;
...
var G__47445 = clojure.zip.remove(zloc__$1);
zloc__$1 = G__47445;
continue;
}
break;
...
var G__47447 = rewrite_clj.zip.utils.remove_right(zloc__$1);
zloc__$1 = G__47447;
continue;
} else {
return zloc__$1;
...
var G__47448 = rewrite_clj.zip.utils.remove_left(zloc__$1);
zloc__$1 = G__47448;
continue;
} else {
return zloc__$1;
 ...
 */
rewrite_clj.zip.utils.remove_and_move_left = (function rewrite_clj$zip$utils$remove_and_move_left(p__47408){
var vec__47409 = p__47408;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47409,(0),null);
var map__47412 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47409,(1),null);
...
var path = map__47412__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47412__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var loc = vec__47409;
if(cljs.core.seq(l)){
 ...
 * location, returns `nil`.
 */
rewrite_clj.zip.utils.remove_and_move_right = (function rewrite_clj$zip$utils$remove_and_move_right(p__47420){
var vec__47421 = p__47420;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47421,(0),null);
var map__47424 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47421,(1),null);
...
var path = map__47424__$1;
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47424__$1,new cljs.core.Keyword(null,"r","r",-471384190));
var loc = vec__47421;
if(cljs.core.seq(r)){
...
var vec__47430 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47430,(0),null);
var map__47433 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47430,(1),null);
var map__47433__$1 = (((((!((map__47433 == null))))?(((((map__47433.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__47433.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__47433):map__47433);
var path = map__47433__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47433__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var ppath = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47433__$1,new cljs.core.Keyword(null,"ppath","ppath",-1758182784));
var pnodes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47433__$1,new cljs.core.Keyword(null,"pnodes","pnodes",1739080565));
var rs = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47433__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if((path == null)){
