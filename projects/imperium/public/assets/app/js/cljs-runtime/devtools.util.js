...
var _STAR_print_newline_STAR__orig_val__41019_41151 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__41020_41152 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__41021_41153 = true;
var _STAR_print_fn_STAR__temp_val__41022_41154 = (function (x__4668__auto__){
return sb__4667__auto__.append(x__4668__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__41021_41153);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__41022_41154);

try{var _STAR_print_level_STAR__orig_val__41023_41155 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__41024_41156 = (300);
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__41024_41156);

try{cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.pprint.pprint,args);
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__41023_41155);
}}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__41020_41152);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__41019_41151);
}
...
return self__4724__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq41015));
}));
...
var new_formatters = current_formatters.filter((function (p1__41110_SHARP_){
return (!(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(detector,p1__41110_SHARP_)));
}));
...
var G__41111_41164 = f;
var target__40567__auto___41165 = G__41111_41164;
if(cljs.core.truth_(target__40567__auto___41165)){
} else {
throw (new Error(["Assert failed: ",["unable to locate object path ",null," in ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__41111_41164)].join(''),"\n","target__40567__auto__"].join('')));
}

(target__40567__auto___41165["toString"] = (function (){
...
var G__41116_41168 = "%c%s";
var G__41117_41169 = "color:transparent";
var G__41118_41170 = devtools.util.make_detection_printer();
(f.cljs$core$IFn$_invoke$arity$3 ? f.cljs$core$IFn$_invoke$arity$3(G__41116_41168,G__41117_41169,G__41118_41170) : f.call(null,G__41116_41168,G__41117_41169,G__41118_41170));
...
var vec__41125 = devtools.util.feature_list_display(installed_features,feature_groups);
var fmt_str = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41125,(0),null);
var fmt_params = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41125,(1),null);
return devtools.util.wrap_with_custom_formatter_detection_BANG_((function() { 
var G__41178__delegate = function (add_fmt,add_args){
...
var G__41178 = function (add_fmt,var_args){
var add_args = null;
if (arguments.length > 1) {
var G__41179__i = 0, G__41179__a = new Array(arguments.length -  1);
while (G__41179__i < G__41179__a.length) {G__41179__a[G__41179__i] = arguments[G__41179__i + 1]; ++G__41179__i;}
  add_args = new cljs.core.IndexedSeq(G__41179__a,0,null);
} 
return G__41178__delegate.call(this,add_fmt,add_args);};
G__41178.cljs$lang$maxFixedArity = 1;
G__41178.cljs$lang$applyTo = (function (arglist__41180){
var add_fmt = cljs.core.first(arglist__41180);
var add_args = cljs.core.rest(arglist__41180);
return G__41178__delegate(add_fmt,add_args);
});
...
/** @this {Function} */
(devtools.util.display_banner_BANG_.cljs$lang$applyTo = (function (seq41119){
var G__41120 = cljs.core.first(seq41119);
var seq41119__$1 = cljs.core.next(seq41119);
var G__41121 = cljs.core.first(seq41119__$1);
var seq41119__$2 = cljs.core.next(seq41119__$1);
var G__41122 = cljs.core.first(seq41119__$2);
var seq41119__$3 = cljs.core.next(seq41119__$2);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__41120,G__41121,G__41122,seq41119__$3);
}));
...
var seq__41134 = cljs.core.seq(features);
var chunk__41135 = null;
var count__41136 = (0);
var i__41137 = (0);
while(true){
if((i__41137 < count__41136)){
var feature = chunk__41135.cljs$core$IIndexed$_nth$arity$2(null,i__41137);
...
var G__41181 = seq__41134;
var G__41182 = chunk__41135;
var G__41183 = count__41136;
var G__41184 = (i__41137 + (1));
seq__41134 = G__41181;
chunk__41135 = G__41182;
count__41136 = G__41183;
i__41137 = G__41184;
continue;
} else {
var temp__5735__auto__ = cljs.core.seq(seq__41134);
if(temp__5735__auto__){
var seq__41134__$1 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(seq__41134__$1)){
var c__4556__auto__ = cljs.core.chunk_first(seq__41134__$1);
var G__41185 = cljs.core.chunk_rest(seq__41134__$1);
var G__41186 = c__4556__auto__;
var G__41187 = cljs.core.count(c__4556__auto__);
var G__41188 = (0);
seq__41134 = G__41185;
chunk__41135 = G__41186;
count__41136 = G__41187;
i__41137 = G__41188;
continue;
} else {
var feature = cljs.core.first(seq__41134__$1);
if(cljs.core.not(cljs.core.some(cljs.core.PersistentHashSet.createAsIfByAssoc([feature]),known_features))){
devtools.context.get_console.call(null).warn(devtools.util.unknown_feature_msg.call(null,feature,known_features,lib_info));
} else {
}
...
var G__41189 = cljs.core.next(seq__41134__$1);
var G__41190 = null;
var G__41191 = (0);
var G__41192 = (0);
seq__41134 = G__41189;
chunk__41135 = G__41190;
count__41136 = G__41191;
i__41137 = G__41192;
continue;
}
} else {
...
if(cljs.core.truth_(temp__5733__auto__)){
var o41140 = temp__5733__auto__;
return (o41140["version"]);
} else {
return null;
}
})() == null);
