...
var G__43076 = o;
goog.object.set(G__43076,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__43111__delegate = function (args){
...
while (G__43112__i < G__43112__a.length) {G__43112__a[G__43112__i] = arguments[G__43112__i + 0]; ++G__43112__i;}
  args = new cljs.core.IndexedSeq(G__43112__a,0,null);
} 
return G__43111__delegate.call(this,args);};
G__43111.cljs$lang$maxFixedArity = 0;
G__43111.cljs$lang$applyTo = (function (arglist__43113){
var args = cljs.core.seq(arglist__43113);
return G__43111__delegate(args);
});
...
var G__43077 = o;
goog.object.set(G__43077,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__43120__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
...
while (G__43124__i < G__43124__a.length) {G__43124__a[G__43124__i] = arguments[G__43124__i + 0]; ++G__43124__i;}
  args = new cljs.core.IndexedSeq(G__43124__a,0,null);
} 
return G__43120__delegate.call(this,args);};
G__43120.cljs$lang$maxFixedArity = 0;
G__43120.cljs$lang$applyTo = (function (arglist__43125){
var args = cljs.core.seq(arglist__43125);
return G__43120__delegate(args);
});
...
var G__43079 = props;
var G__43079__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__43079,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__43079);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__43079__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__4126__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__43081 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__43081,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__43081;
}
})(),id_class);
...
var G__43085 = (cljs.core.count(argv) - first_child);
switch (G__43085) {
case (0):
...
var vec__43093 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43093,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43093,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43093,(2),null);
...
var temp__5739__auto___43146 = reagent.impl.util.react_key_from_vec(v);
if((temp__5739__auto___43146 == null)){
} else {
var key_43147 = temp__5739__auto___43146;
(jsprops.key = key_43147);
}
...
var temp__5739__auto___43148 = reagent.impl.util.react_key_from_vec(v);
if((temp__5739__auto___43148 == null)){
} else {
var key_43149 = temp__5739__auto___43148;
(jsprops.key = key_43149);
}
...
var temp__5739__auto___43154 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5739__auto___43154 == null)){
} else {
var key_43155 = temp__5739__auto___43154;
(jsprops.key = key_43155);
}
...
var temp__5739__auto___43162 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5739__auto___43162 == null)){
} else {
var key_43163 = temp__5739__auto___43162;
(jsprops.key = key_43163);
}
...
var temp__5739__auto___43167 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5739__auto___43167 == null)){
} else {
var key_43168 = temp__5739__auto___43167;
(jsprops.key = key_43168);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__43099_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__43099_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__43100 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43100,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43100,(1),null);
...
break;
default:
var G__43175 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__43176 = compiler;
v = G__43175;
compiler = G__43176;
continue;
...
var G__43104 = tag;
var G__43104__$1 = (((G__43104 instanceof cljs.core.Keyword))?G__43104.fqn:null);
switch (G__43104__$1) {
case ">":
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template43106 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template43106 = (function (opts,id,fn_to_element,meta43107){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template43106.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_43108,meta43107__$1){
var self__ = this;
var _43108__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template43106(self__.opts,self__.id,self__.fn_to_element,meta43107__$1));
}));

(reagent.impl.template.t_reagent$impl$template43106.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_43108){
var self__ = this;
var _43108__$1 = this;
return self__.meta43107;
}));

(reagent.impl.template.t_reagent$impl$template43106.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template43106.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template43106.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template43106.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template43106.getBasis = (function (){
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"meta43107","meta43107",-255325473,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template43106.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template43106.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template43106");

(reagent.impl.template.t_reagent$impl$template43106.cljs$lang$ctorPrWriter = (function (this__4369__auto__,writer__4370__auto__,opt__4371__auto__){
return cljs.core._write(writer__4370__auto__,"reagent.impl.template/t_reagent$impl$template43106");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template43106.
 */
reagent.impl.template.__GT_t_reagent$impl$template43106 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template43106(opts__$1,id__$1,fn_to_element__$1,meta43107){
return (new reagent.impl.template.t_reagent$impl$template43106(opts__$1,id__$1,fn_to_element__$1,meta43107));
});

}

return (new reagent.impl.template.t_reagent$impl$template43106(opts,id,fn_to_element,cljs.core.PersistentArrayMap.EMPTY));
});
