...
(rewrite_clj.node.uneval.UnevalNode.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4382__auto__,k46956,else__4383__auto__){
var self__ = this;
var this__4382__auto____$1 = this;
var G__46960 = k46956;
var G__46960__$1 = (((G__46960 instanceof cljs.core.Keyword))?G__46960.fqn:null);
switch (G__46960__$1) {
case "children":
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k46956,else__4383__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__4402__auto__,p__46961){
...
(rewrite_clj.node.uneval.UnevalNode.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__46955){
var self__ = this;
var G__46955__$1 = this;
return (new cljs.core.RecordIter((0),G__46955__$1,1,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"children","children",-940561982)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(rewrite_clj.node.uneval.UnevalNode.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this46957,other46958){
var self__ = this;
var this46957__$1 = this;
return (((!((other46958 == null)))) && ((this46957__$1.constructor === other46958.constructor)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this46957__$1.children,other46958.children)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this46957__$1.__extmap,other46958.__extmap)));
}));
...
(rewrite_clj.node.uneval.UnevalNode.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4387__auto__,k__4388__auto__,G__46955){
var self__ = this;
var this__4387__auto____$1 = this;
var pred__46976 = cljs.core.keyword_identical_QMARK_;
var expr__46977 = k__4388__auto__;
if(cljs.core.truth_((pred__46976.cljs$core$IFn$_invoke$arity$2 ? pred__46976.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"children","children",-940561982),expr__46977) : pred__46976.call(null,new cljs.core.Keyword(null,"children","children",-940561982),expr__46977)))){
return (new rewrite_clj.node.uneval.UnevalNode(G__46955,self__.__meta,self__.__extmap,null));
} else {
return (new rewrite_clj.node.uneval.UnevalNode(self__.children,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4388__auto__,G__46955),null));
}
}));
...
(rewrite_clj.node.uneval.UnevalNode.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4379__auto__,G__46955){
var self__ = this;
var this__4379__auto____$1 = this;
return (new rewrite_clj.node.uneval.UnevalNode(self__.children,G__46955,self__.__extmap,self__.__hash));
}));
 ...
 */
rewrite_clj.node.uneval.map__GT_UnevalNode = (function rewrite_clj$node$uneval$map__GT_UnevalNode(G__46959){
var extmap__4419__auto__ = (function (){var G__46984 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(G__46959,new cljs.core.Keyword(null,"children","children",-940561982));
if(cljs.core.record_QMARK_(G__46959)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__46984);
} else {
return G__46984;
}
})();
return (new rewrite_clj.node.uneval.UnevalNode(new cljs.core.Keyword(null,"children","children",-940561982).cljs$core$IFn$_invoke$arity$1(G__46959),null,cljs.core.not_empty(extmap__4419__auto__),null));
});
...
var G__46999 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [children], null);
children = G__46999;
continue;
}
break;
