...
day8.re_frame_10x.inlined_deps.re_frame.v1v1v2.re_frame.trace.start_trace = (function day8$re_frame_10x$inlined_deps$re_frame$v1v1v2$re_frame$trace$start_trace(p__42806){
var map__42807 = p__42806;
var map__42807__$1 = (((((!((map__42807 == null))))?(((((map__42807.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__42807.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__42807):map__42807);
var operation = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42807__$1,new cljs.core.Keyword(null,"operation","operation",-1267664310));
var op_type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42807__$1,new cljs.core.Keyword(null,"op-type","op-type",-1636141668));
var tags = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42807__$1,new cljs.core.Keyword(null,"tags","tags",1771418977));
var child_of = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42807__$1,new cljs.core.Keyword(null,"child-of","child-of",-903376662));
...
var seq__42813_42857 = cljs.core.seq(cljs.core.deref(day8.re_frame_10x.inlined_deps.re_frame.v1v1v2.re_frame.trace.trace_cbs));
var chunk__42814_42858 = null;
var count__42815_42859 = (0);
var i__42816_42860 = (0);
while(true){
if((i__42816_42860 < count__42815_42859)){
var vec__42831_42861 = chunk__42814_42858.cljs$core$IIndexed$_nth$arity$2(null,i__42816_42860);
var k_42862 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42831_42861,(0),null);
var cb_42863 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42831_42861,(1),null);
try{var G__42835_42864 = cljs.core.deref(day8.re_frame_10x.inlined_deps.re_frame.v1v1v2.re_frame.trace.traces);
(cb_42863.cljs$core$IFn$_invoke$arity$1 ? cb_42863.cljs$core$IFn$_invoke$arity$1(G__42835_42864) : cb_42863.call(null,G__42835_42864));
}catch (e42834){var e_42865 = e42834;
day8.re_frame_10x.inlined_deps.re_frame.v1v1v2.re_frame.loggers.console.cljs$core$IFn$_invoke$arity$variadic(new cljs.core.Keyword(null,"error","error",-978969032),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["Error thrown from trace cb",k_42862,"while storing",cljs.core.deref(day8.re_frame_10x.inlined_deps.re_frame.v1v1v2.re_frame.trace.traces),e_42865], 0));
}

var G__42871 = seq__42813_42857;
var G__42872 = chunk__42814_42858;
var G__42873 = count__42815_42859;
var G__42874 = (i__42816_42860 + (1));
seq__42813_42857 = G__42871;
chunk__42814_42858 = G__42872;
count__42815_42859 = G__42873;
i__42816_42860 = G__42874;
continue;
} else {
var temp__5735__auto___42876 = cljs.core.seq(seq__42813_42857);
if(temp__5735__auto___42876){
var seq__42813_42877__$1 = temp__5735__auto___42876;
if(cljs.core.chunked_seq_QMARK_(seq__42813_42877__$1)){
var c__4556__auto___42878 = cljs.core.chunk_first(seq__42813_42877__$1);
var G__42879 = cljs.core.chunk_rest(seq__42813_42877__$1);
var G__42880 = c__4556__auto___42878;
var G__42881 = cljs.core.count(c__4556__auto___42878);
var G__42882 = (0);
seq__42813_42857 = G__42879;
chunk__42814_42858 = G__42880;
count__42815_42859 = G__42881;
i__42816_42860 = G__42882;
continue;
} else {
var vec__42837_42883 = cljs.core.first(seq__42813_42877__$1);
var k_42884 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42837_42883,(0),null);
var cb_42885 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42837_42883,(1),null);
try{var G__42841_42889 = cljs.core.deref(day8.re_frame_10x.inlined_deps.re_frame.v1v1v2.re_frame.trace.traces);
(cb_42885.cljs$core$IFn$_invoke$arity$1 ? cb_42885.cljs$core$IFn$_invoke$arity$1(G__42841_42889) : cb_42885.call(null,G__42841_42889));
}catch (e42840){var e_42890 = e42840;
day8.re_frame_10x.inlined_deps.re_frame.v1v1v2.re_frame.loggers.console.cljs$core$IFn$_invoke$arity$variadic(new cljs.core.Keyword(null,"error","error",-978969032),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["Error thrown from trace cb",k_42884,"while storing",cljs.core.deref(day8.re_frame_10x.inlined_deps.re_frame.v1v1v2.re_frame.trace.traces),e_42890], 0));
}

var G__42891 = cljs.core.next(seq__42813_42877__$1);
var G__42892 = null;
var G__42893 = (0);
var G__42894 = (0);
seq__42813_42857 = G__42891;
chunk__42814_42858 = G__42892;
count__42815_42859 = G__42893;
i__42816_42860 = G__42894;
continue;
}
} else {
}
